...
public class GuiNamingTag extends GuiScreen {
    ...
    protected void keyTyped(char c, int i) {
        ...
        ((GuiButton)this.controlList.get(0)).enabled = this.nameField.getText().trim().length() > 0;
        if (c == '\n' || c == '\r') {
    ...
    protected void drawGuiBackground() {
        ...
        ForgeHooksClient.bindTexture("/mods/vintagebarrels/textures/gui/namingTool.png", 0);
